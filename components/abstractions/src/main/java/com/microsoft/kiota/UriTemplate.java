// Original implementation from: https://github.com/micronaut-projects/micronaut-core/blob/02992a905cf9a2279b7fe8e49927ff080cb937d5/http/src/main/java/io/micronaut/http/uri/UriTemplate.java#L1
/*
...
class UriTemplate implements Comparable<UriTemplate> {
    ...
    protected static class UriTemplateParser {
        ...
        private static class RawPathSegment implements PathSegment {
            ...
            @Override
            public int hashCode() {
                return Objects.hash(isQuerySegment, value);
            }
        ...
        private static class VariablePathSegment implements PathSegment {
            ...
            public String expand(Map<String, Object> parameters, boolean previousHasContent, boolean anyPreviousHasOperator) {
                ...
                if (found != null && !(isOptional && !((Optional) found).isPresent())) {
                    ...
                    } else if (found instanceof OffsetDateTime) {
                        String str = ((OffsetDateTime) found).format(RFC3339);
