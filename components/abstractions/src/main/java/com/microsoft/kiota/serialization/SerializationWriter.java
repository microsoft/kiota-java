...
public interface SerializationWriter extends Closeable {
     ...
     */
    <T> void writeCollectionOfPrimitiveValues(
     ...
     */
    <T extends Parsable> void writeCollectionOfObjectValues(
            @Nullable final String key, @Nullable final Iterable<T> values);
     ...
     */
    <T extends Enum<T>> void writeCollectionOfEnumValues(
            @Nullable final String key, @Nullable final Iterable<T> values);
     ...
     */
    <T extends Parsable> void writeObjectValue(
     ...
     * @param <T> the type of the enum.
     */
    <T extends Enum<T>> void writeEnumSetValue(
